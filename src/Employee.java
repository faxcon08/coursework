public class Employee {
    ...
    private boolean checkString(String str) { // примитивная проверка строки
   ...
   ////////////////////////////////////////////////
    ...
    public String toString() {
        return String.format("Департамент_%02d Сотрудник: %20s Зарпалта:%,10.2d",department,fullName,salary);
    }
